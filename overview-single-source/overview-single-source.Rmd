...
abstract: >
  In this paper we provide an overview of R packages that allow to fit various single-source capture-recapture (SSCR) models. In genera, SSCR approaches assume that capture history follows certain distribution (e.g. negative binomial, poisson, one-inflated poisson) but the observational data consist only positive counts i.e. we observe zero truncated distributions. 
preamble: |
  \include{symbols.tex}
